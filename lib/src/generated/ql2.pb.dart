...
class VersionDummy extends $pb.GeneratedMessage {
  ...
  factory VersionDummy.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory VersionDummy.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<VersionDummy> createRepeated() => $pb.PbList<VersionDummy>();
...
class Query_AssocPair extends $pb.GeneratedMessage {
  ...
  factory Query_AssocPair.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Query_AssocPair.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<Query_AssocPair> createRepeated() => $pb.PbList<Query_AssocPair>();
...
class Query extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Query')
    ...
    ..aOB(5, 'acceptsRJson')
    ..pc<Query_AssocPair>(6, 'globalOptargs', $pb.PbFieldType.PM,Query_AssocPair.create)
    ..hasRequiredFields = false
  ;
...
class Frame extends $pb.GeneratedMessage {
  ...
  set opt($core.String v) { $_setString(2, v); }
...
class Backtrace extends $pb.GeneratedMessage {
  ...
  factory Backtrace.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Backtrace.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
...
class Response extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Response')
    ...
    ..pc<Response_ResponseNote>(6, 'notes', $pb.PbFieldType.PE, null, Response_ResponseNote.valueOf, Response_ResponseNote.values)
...
class Datum_AssocPair extends $pb.GeneratedMessage {
  ...
  factory Datum_AssocPair.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Datum_AssocPair.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<Datum_AssocPair> createRepeated() => $pb.PbList<Datum_AssocPair>();
...
class Datum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Datum')
    ...
    ..pc<Datum_AssocPair>(6, 'rObject', $pb.PbFieldType.PM,Datum_AssocPair.create)
    ..hasRequiredFields = false
  ;
...
class Term_AssocPair extends $pb.GeneratedMessage {
  ...
  factory Term_AssocPair.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Term_AssocPair.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  static $pb.PbList<Term_AssocPair> createRepeated() => $pb.PbList<Term_AssocPair>();
...
class Term extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Term')
    ...
    ..pc<Term_AssocPair>(4, 'optargs', $pb.PbFieldType.PM,Term_AssocPair.create)
    ..hasRequiredFields = false
  ;

  Term._() : super();
  factory Term() => create();
  factory Term.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Term.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
